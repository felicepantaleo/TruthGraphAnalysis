...
From `signal`, the children of the Z. See `cpp/Resonance.cc` and `py/resonance.py`: the two print the same lines.
...
```
resonance 23 -> 11 -11: m(ll) 87.25 GeV, generator mass 87.25 GeV
```
